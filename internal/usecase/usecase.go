...
type Storage interface {
	...
	CreateTask(ctx context.Context, task entity.Task, tagsIDs []int64) (*entity.Task, error)
	...
	AddTagToTask(ctx context.Context, tagID, taskID int64) error
	RemoveTagFromTask(ctx context.Context, tagID, taskID int64) error
